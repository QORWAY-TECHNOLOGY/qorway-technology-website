      ...
      <PageIntroGrid
        items={[
          ...
          },
          {
            ...
            body: "Evaluate QORWAY through European digital sovereignty, resilience, governance, and accountable decision infrastructure."
          }
        ]}
      />
      ...
      <section className="qorway-container py-16">
        <Panel>
          ...
          <h2 className="max-w-4xl text-4xl font-semibold tracking-[-0.04em] text-qorway-cream">
            Pilot conversations begin from public-safe architecture.
          </h2>
          <p className="mt-6 max-w-3xl leading-8 text-qorway-sand">
            The public website explains what QORWAY is, why it exists, and how its architecture is organized. Further work can be scoped through a structured pilot discussion.
          </p>
        </Panel>
      </section>
    </PageShell>
